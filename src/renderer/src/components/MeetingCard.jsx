...
export const MeetingCard = ({isSingleCard, title, time, status, failed }) => {
  return (
    <div className={`flex items-center justify-between p-3 rounded-lg border border-border bg-gray-50 ${isSingleCard ? 'w-full' : 'min-w-[400px]'}`}>
